...
Another great way to contribute is to actually use glyphos for your Open Source or Commercial projects. If you do, make sure to open an issue with a link to your project.
...
* Remain backwards compatible when possible.
    Backward compatibility is not critical since projects do not depend on GlyphOS. But it's a good idea to have stable features and usage.
* Reduce dependencies.
